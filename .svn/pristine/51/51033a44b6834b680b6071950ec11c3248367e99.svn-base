...
static
void
kill_curthread(u_int32_t epc, unsigned code, u_int32_t vaddr)  // handle broken user programs
{
 ...
 */
void
mips_trap(struct trapframe *tf)  // return control to the OS
{
 ...
 */
void
md_usermode(int argc, userptr_t argv, vaddr_t stack, vaddr_t entry)  // return control to user programs
{
	struct trapframe tf;

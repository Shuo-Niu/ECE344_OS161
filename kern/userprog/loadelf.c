...
//		}
//        //********************************************
//        kprintf("Before defining region i=%d\n", i);
//        //********************************************
//		result = as_define_region(v, offset,
//                                  curthread->t_vmspace,
...
//	}
//
//	int filling = PAGE_SIZE - filesize;
//	if(filling > 0){
//		DEBUG(DB_EXEC,"ELF: Filling %lu more bytes\n",(unsigned long)filling);
//		ku.uio_resid += filling;
//		bzero(vaddr + filesize,filling);
//	}
//
//	return 0;
//}
